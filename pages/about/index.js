    ...
    data(){
        return{
            ...
            platforms:[
                ...
                {label:'语雀',icon:'/icon/about/yuque.svg',url:'https://www.yuque.com/books/share/1e1b68a5-fefd-4647-a3db-8266e73072e6?#'},
                {label:'掘金',icon:'/icon/about/juejin.svg',url:'https://juejin.cn/user/4309700183594366'},
                {label:'CSDN',icon:'/icon/about/csdn.svg',url:'https://blog.csdn.net/weixin_43803691?spm=1000.2115.3001.5113'},
            ...
            stacks:[
                {
                    ...
                    stacks:[
                        ...
                        {label:'BoostrapVue',icon:'/icon/about/bootstrapVue.svg',url:'https://bootstrap-vue.org/'},
                        {label:'Google Analytics',icon:'/icon/about/ga.svg',url:'https://analytics.google.com/analytics/academy/'}
                    ]
                },
                {
                    title:'微信小程序',
